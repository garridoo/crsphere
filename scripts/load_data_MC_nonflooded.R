...
design.file <- paste(data.dir, "design_NC_nonflooded_16s.txt", sep="")
asv_table.file <- paste(results.dir, "asv_table_NC_nonflooded_16s.txt", sep="")
taxonomy.file <- paste(results.dir, "taxonomy_NC_nonflooded_16s.txt", sep="")
