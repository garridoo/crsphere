...
design.file <- paste(data.dir, "design_MC_algae_survey.txt", sep="")
asv_table.file <- paste(results.dir, "asv_table_MC_algae_survey.txt", sep="")
taxonomy.file <- paste(results.dir, "taxonomy_MC_algae_survey.txt", sep="")
